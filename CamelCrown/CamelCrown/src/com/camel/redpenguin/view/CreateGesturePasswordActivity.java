...
import com.camel.redpenguin.ui.BaseActivity;
import com.camel.redpenguin.ui.SafetyLockActivity;
import com.camel.redpenguin.util.LockPatternUtils;
import com.camel.redpenguin.view.LockPatternView.Cell;
import com.camel.redpenguin.view.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends BaseActivity implements
	...
	private void saveChosenPatternAndFinish() {
		CustomApplcation.getInstance().getLockPatternUtils().saveLockPattern(mChosenPattern);
		showToast("密码设置成功");
		//startActivity(new Intent(this, SafetyLockActivity.class));
		finish();
	}
}
